      ...
      <ScrollView>
        <View>
          <Dialog.Container visible={cancelDialogVisible}>
            ...
            <Dialog.Description style={styles.dialogContent}>
              Mail was not sent - are you sure?
            </Dialog.Description>
            <Dialog.Button label="No" onPress={() => handleCancelNoDialog()} />
            <Dialog.Button
              label="Yes"
              onPress={() => handleCancelYesDialog()}
            />
          </Dialog.Container>
        </View>
        <View>
          <Dialog.Container visible={sendDialogVisible}>
            <Dialog.Title style={styles.dialogTitle}>Attention</Dialog.Title>
            <Dialog.Description style={styles.dialogContent}>
              Not all field are correct, email can not be sent
            </Dialog.Description>
        ...
        <View style={styles.titleAndButtonContainer}>
          <View style={styles.titleAndButtonRow}>
            ...
            <TouchableOpacity onPress={() => handleOnSendEmailPressed()}>
              <Image source={require('../../../images/emailSendIcon.png')} />
            </TouchableOpacity>
          </View>
        </View>
